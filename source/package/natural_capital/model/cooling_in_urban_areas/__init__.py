...
def function(
    ...
    # aanpassing: alle vegetatiekaarten hebben waarden tussen 0 en 1
    ...
    # TODO Sanitize data, remove when no-data in rasters is set to zero
    ...
    # RK: This is shut of when the model was applied to the entire Netherlands
    #    validate.greater_equal_than(population_10km, -1e-6)
    ...
    #    validate.greater_equal_than(built_up_1km, -1e-6) # RK: removed for national calculation
    ...
    #    validate.greater_equal_than(reduction_30m, -1e-6) # RK: removed for national calculation
